...
<style>
    ...
    .category-sport {
        color: #26de81;
        background: linear-gradient(135deg, rgba(38, 222, 129, 0.15), rgba(32, 191, 107, 0.15));
    }

    .category-others {
        color: #fd9644;
        background: linear-gradient(135deg, rgba(253, 150, 68, 0.15), rgba(243, 133, 49, 0.15));
    }
            ...
            @foreach ($events as $event)
                <div class="event-item">
                    ...
                    <div class="event-content">
                        <div>
                            <span class="event-category category-{{ strtolower($event->name) }}">
                                {{ $event->name }}
                            </span>
